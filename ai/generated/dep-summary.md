...
- **shared/logisticsConstants.ts** — depended on by 9 modules
...
- **client/worldData.ts** — depended on by 42 modules
...
- **shared/segmentGraph.ts** ← client/aiTurn.ts, client/aiTurn.ts
...
- **shared/segmentGraph.ts** ← server/aiTurnApi.ts, server/combatApi.ts
...
- **src/world/logisticsSeed.ts** ← server/generateApi.ts, server/matchApi.ts
...
- **shared/logisticsConstants.ts** ← 4 modules
...
- **shared/segmentGraph.ts** ← src/world/movement.ts
